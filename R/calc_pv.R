...
calc_pv<-function(surv_mat, fert_mat, N0_data, nstage, years, stage2mod, beta, active_stages, verbose=FALSE){
  ...
  abundance<- calc_abundance(N0_data, surv_trend, fert_rand, years)
  if (verbose) {
    print(abundance)
