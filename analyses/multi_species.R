...
for (k in 1:num_pops) {
  ...
  #Running simulations
  return_pv<-replicate(100, calc_pv(surv_mat, fert_mat, trans_mat, fert_zero, N0_data, nstage, years=1:10, stage2mod=active_stages, beta=0.01, active_stages = active_stages))
