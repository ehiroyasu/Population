...
return_pv<-replicate(10000, calc_pv(surv_mat, fert_mat, trans_mat, N0_data, nstage, years=1:10, stage2mod=c(1,2), beta=0.01, active_stages = active_stages))
```
...
#Plots
```{r, echo=FALSE}
plot(prop_demog~alpha, type='l',col='blue', xlab='alpha', ylab='freq p<alpha', main='Frequency p-value is less than alpha', xlim=c(0,0.2), ylim=c(0,0.5))
...
hist(survival_pv, main='Histgram of survival p-values')
```
