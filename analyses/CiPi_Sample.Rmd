...
prop_lambda<-lambda_lessthan_alpha(lambda_pv, alpha)
...
```{r, echo=FALSE}
plot(prop_demog~alpha, type='l', col='blue', xlab='freq p<alpha', ylab='alpha', main='Frequency p is less than alpha')
